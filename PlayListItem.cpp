...
/*!
 ...
 \param parent
*/
PlayListItem::PlayListItem(const QString& name, QListWidget* parent) : QListWidgetItem(parent) {
...
/*!
 ...
 \return QString
*/
QString PlayListItem::copyFilesName(const M3uEntry& e){
...
/*!
 ...
 \return QString
*/
QString PlayListItem::playListEntry(const M3uEntry& e) const {
...
/*!
 ...
 \param log
*/
void PlayListItem::copyFoundFiles(QList<M3uEntry> songs, QString* log) {
...
/*!
 ...
 \return bool
*/
bool PlayListItem::generate(QList<M3uEntry> *songsOut, QString* log, QHash<QString, Tag*> *tags) {
...
/*!
 ...
 \return bool
*/
bool PlayListItem::writeM3U(const QString& file, const QList<M3uEntry> &songs, QString* log) const {
...
*/
QList<M3uEntry> PlayListItem::findFiles(bool* canceled, QString* log, QHash<QString, Tag*> *tags){
...
/*!
 ...
 \return QList<M3uEntry>
*/
QList<M3uEntry>  PlayListItem::processFile(const QFileInfo& fileInfo, bool hasTagRule, bool hasAudioRule, bool keepTags, const QString &format, bool useScript, QString* log, QHash<QString, Tag*> *tags, QHash<QString, Tag*> *tagsCopy, bool *wasCanceled ) const {
...
/*!
 ...
 \param engine
*/
QScriptValue PlayListItem::contains(QScriptContext *context, QScriptEngine *engine){
...
QScriptValue PlayListItem::myAdd(QScriptContext *context, QScriptEngine *engine){
    Q_UNUSED(engine)
...
/*!
 ...
 \param log
*/
bool PlayListItem::evaluateScript( const Tag* tag, const QFileInfo& fileInfo, QString *log ) const {
...
/*!
 ...
 \param anyOk
*/
void PlayListItem::evaluateRules(const Tag* tag, const QString& file, bool* allOk, bool* anyOk) const {
...
/*!
 ...
 \return QString
*/
QString PlayListItem::createExtInfString(const Tag* tag, const QString& file, const QString& format_) const {
...
/*!
 ...
 \param shouldBeTrue
*/
void PlayListItem::checkRule(bool value, bool* allOk, bool* anyOk, bool shouldBeTrue) const {
    if (value) {
...
/*!
 ...
 \param shouldBeTrue
*/
void PlayListItem::checkRange(const QVector<int> &intvals, int value, bool* allOk, bool* anyOk, bool shouldBeTrue) const {
...
/*!
 ...
 \return QVector<Rule>
*/
QVector<Rule> PlayListItem::rules() const {
    return rules_;
}
...
/*!
 ...
 \return QList<QDir>
*/
QList<QDir> PlayListItem::folders() const {
    return folders_;
}
...
/*!
 ...
 \return QStringList
*/
QStringList PlayListItem::extensions() const {
    return extensions_;
}
...
/*!
 ...
 \return bool
*/
bool PlayListItem::randomize() const {
    return randomize_;
}
...
/*!
 ...
 \return bool
*/
bool PlayListItem::includeSubFolders() const {
...
/*!
 ...
 \return bool
*/
bool PlayListItem::relativePath() const {
...
/*!
 ...
 \return bool
*/
bool PlayListItem::allRulesTrue() const {
...
/*!
 ...
 \return bool
*/
bool PlayListItem::includeExtInf() const {
...
/*!
 ...
 \return bool
*/
bool PlayListItem::makeUnique() const {
    return makeUnique_;
}
...
/*!
 ...
 \return QDir
*/
QDir PlayListItem::copyFilesToDir() const {
...
/*!
 ...
 \return bool
*/
bool PlayListItem::copyFiles() const {
    return copyFiles_;
}
...
*/
QList<QFileInfo> PlayListItem::individualFiles() const {
...
/*!
 ...
 \return QString
*/
QString PlayListItem::script() const {
    return script_;
}
...
/*!
 ...
 \param rules
*/
void PlayListItem::setRules(const QVector<Rule> &rules) {
    rules_ = rules;
}
...
/*!
 ...
 \param folders
*/
void PlayListItem::setFolders(const QList<QDir> &folders) {
    folders_ = folders;
}
...
/*!
 ...
 \param extensions
*/
void PlayListItem::setExtensions(const QStringList& extensions) {
...
/*!
 ...
 \param randomize
*/
void PlayListItem::setRandomize(bool randomize) {
...
*/
void PlayListItem::setIncludeSubFolders(bool includeSubFolders) {
...
/*!
 ...
 \param relativePath
*/
void PlayListItem::setRelativePath(bool relativePath) {
...
/*!
 ...
 \param allRulesTrue
*/
void PlayListItem::setAllRulesTrue(bool allRulesTrue) {
...
/*!
 ...
 \param includeExtInf
*/
void PlayListItem::setIncludeExtInf(bool includeExtInf) {
...
/*!
 ...
 \param makeUnique
*/
void PlayListItem::setMakeUnique(bool makeUnique) {
...
*/
void PlayListItem::setCopyFilesToDir(const QDir& copyFilesToDir) {
...
/*!
 ...
 \param copyFiles
*/
void PlayListItem::setCopyFiles(bool copyFiles) {
...
*/
void PlayListItem::setIndividualFiles(const QList<QFileInfo> &individualFiles) {
...
/*!
 ...
 \param script
*/
void PlayListItem::setScript(const QString& script) {
    script_ = script;
}
...
*/
PlayListItem::operator QVariant() const {
